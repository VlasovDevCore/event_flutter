                  ...
                  child: Stack(
                    ...
                    children: [
                      CircleAvatar(
                        ...
                        child: CircleAvatar(
                          radius: 15,
                          backgroundImage: displayParticipants[i].avatarUrl != null
                              ? NetworkImage(displayParticipants[i].avatarUrl!)
                              : null,
                          child: displayParticipants[i].avatarUrl == null
                              ? previewLoading
                                  ...
                                  : Text(
                                      displayParticipants[i].label.characters.take(1).toString().toUpperCase(),
